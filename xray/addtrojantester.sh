...
echo -e "🔺️Port GRPC➡️ ${tgrpc},8443,2096,2087,2053"
echo -e "🔺️Port WS TLS➡️ ${ttls},8443,2096,2087,2053"
echo -e "🔺️Port WS NONTLS➡️ $tnontls,2095,2086,2052"
echo -e "🔺️Port H2C➡️ ${thdua}"
echo -e "🔺️Port HTTP TLS➡️ ${thttp},8443,2096"
echo -e "🔺️Port HTTP NONTLS➡️ $thttpnon"

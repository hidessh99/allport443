...
echo -e "🔺️Port WS➡️ $vltls,8443,2096,2087,2053"
echo -e "🔺️Port WS NONTLS➡️ $vlnontls,2095,2086,2052"
echo -e "🔺️Port HTTP➡️ $vlhttp,8443,2096"
echo -e "🔺️Port HTTP NONTLS➡️ $vlhttpnon"

...
echo -e "🔺️Port GRPC➡️ ${vmgrpc},8443,2096,2087,2053"
echo -e "🔺️Port HTTP➡️ ${vmhttp},8443,2096"
echo -e "🔺️Port H2C➡️ ${vmhdua}"
echo -e "🔺️Port HTTP➡️ ${vmhttpnon}"
echo -e "🔺️Port QUIC➡️ ${vmquic}"

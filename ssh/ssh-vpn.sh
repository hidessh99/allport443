...
DAEMON_OPTS="--user sslh --listen 0.0.0.0:2087 --ssl 127.0.0.1:500 --ssh 127.0.0.1:300 --openvpn 127.0.0.1:400 --openvpn 127.0.0.1:600 --http 127.0.0.1:2086 --http 127.0.0.1:2083 --pidfile /var/run/sslh/sslh.pid -n"

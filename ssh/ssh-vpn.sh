...
DAEMON_OPTS="--user sslh --listen 0.0.0.0:100 --ssl 127.0.0.1:500 --ssh 127.0.0.1:300 --ssh 127.0.0.1:2242 --openvpn 127.0.0.1:700 --openvpn 127.0.0.1:900 --pidfile /var/run/sslh/sslh.pid"

...
status04=$(systemctl status openvpn          | grep -i "active (running)")
...
status20=$(systemctl status ws-tls           | grep -i "active (running)")
status21=$(systemctl status ws-ovpn          | grep -i "active (running)")
status22=$(systemctl status wg-quick@wg0     | grep -i "active (running)")

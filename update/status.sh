...
declare ingfo=()            
#=====================================
status01=$(systemctl status dropbear         | grep -i "active (mlaku)")
status02=$(systemctl status sshd             | grep -i "active (mlaku)")
status03=$(systemctl status stunnel5         | grep -i "active (mlaku)")
status04=$(systemctl status openvpn          | grep -i "active (mlaku)")
status05=$(systemctl status dropbear-ohp     | grep -i "active (mlaku)")
status06=$(systemctl status openvpn-ohp      | grep -i "active (mlaku)")
status07=$(systemctl status ssh-ohp          | grep -i "active (mlaku)")
status08=$(systemctl status ipsec            | grep -i "active (mlaku)")
status09=$(systemctl status accel-ppp        | grep -i "active (mlaku)")
status10=$(systemctl status pptpd            | grep -i "active (mlaku)")
status11=$(systemctl status xl2tpd           | grep -i "active (mlaku)")
status12=$(systemctl status nginx            | grep -i "active (mlaku)")
status13=$(systemctl status squid            | grep -i "active (mlaku)")
status14=$(systemctl status cron             | grep -i "active (mlaku)")
status15=$(systemctl status fail2ban         | grep -i "active (mlaku)")
status16=$(systemctl status vnstat           | grep -i "active (mlaku)")
status17=$(systemctl status sslh             | grep -i "active (mlaku)")
status18=$(systemctl status privoxy          | grep -i "active (mlaku)")
status19=$(systemctl status ws-tls           | grep -i "active (mlaku)")
status19=$(systemctl status ws-nontls        | grep -i "active (mlaku)")
status20=$(systemctl status ws-tls           | grep -i "active (mlaku)")
status21=$(systemctl status ws-ovpn          | grep -i "active (mlaku)")
status22=$(systemctl status wg-quick@wg0     | grep -i "active (mlaku)")
status23=$(systemctl status shadowsocks-libev| grep -i "active (mlaku)")
status23=$(systemctl status shadowsocks-libev| grep -i "active (mlaku)")
status24=$(systemctl status ssrmu            | grep -i "active (mlaku)")
status25=$(systemctl status xray             | grep -i "active (mlaku)")
status26=$(systemctl status xray             | grep -i "active (mlaku)")
status27=$(systemctl status xray             | grep -i "active (mlaku)")
status28=$(systemctl status xray             | grep -i "active (mlaku)")
status29=$(systemctl status xray             | grep -i "active (mlaku)")
status30=$(systemctl status xray             | grep -i "active (mlaku)")
status31=$(systemctl status xray             | grep -i "active (mlaku)")
status32=$(systemctl status xray             | grep -i "active (mlaku)")
status33=$(systemctl status xray             | grep -i "active (mlaku)")
status34=$(systemctl status xray             | grep -i "active (mlaku)")
status35=$(systemctl status xray             | grep -i "active (mlaku)")
status36=$(systemctl status xray             | grep -i "active (mlaku)")
status37=$(systemctl status xray             | grep -i "active (mlaku)")
status38=$(systemctl status xray             | grep -i "active (mlaku)")
status39=$(systemctl status xray             | grep -i "active (mlaku)")
status40=$(systemctl status xray             | grep -i "active (mlaku)")
status41=$(systemctl status xray             | grep -i "active (mlaku)")
status42=$(systemctl status xray             | grep -i "active (mlaku)")
status43=$(systemctl status xray             | grep -i "active (mlaku)")
status44=$(systemctl status xray             | grep -i "active (mlaku)")
status45=$(systemctl status xray             | grep -i "active (mlaku)")
status46=$(systemctl status xray             | grep -i "active (mlaku)")
status47=$(systemctl status xray             | grep -i "active (mlaku)")
status48=$(systemctl status xray             | grep -i "active (mlaku)")
status49=$(systemctl status xray             | grep -i "active (mlaku)")
status50=$(systemctl status xray             | grep -i "active (mlaku)")
status51=$(systemctl status xray             | grep -i "active (mlaku)")
status52=$(systemctl status xray             | grep -i "active (mlaku)")
status53=$(systemctl status xray             | grep -i "active (mlaku)")
status54=$(systemctl status xray             | grep -i "active (mlaku)")
status55=$(systemctl status trojan-go        | grep -i "active (mlaku)")
status56=$(systemctl status xray             | grep -i "active (mlaku)")
status57=$(systemctl status xray             | grep -i "active (mlaku)")
status58=$(systemctl status xray             | grep -i "active (mlaku)")
status59=$(systemctl status xray             | grep -i "active (mlaku)")
status60=$(systemctl status xray             | grep -i "active (mlaku)")
status61=$(systemctl status xray             | grep -i "active (mlaku)")
status62=$(systemctl status xray             | grep -i "active (mlaku)")
status63=$(systemctl status xray             | grep -i "active (mlaku)")
status64=$(systemctl status xray             | grep -i "active (mlaku)")
status65=$(systemctl status xray             | grep -i "active (mlaku)")
status66=$(systemctl status xray             | grep -i "active (mlaku)")
status67=$(systemctl status xray             | grep -i "active (mlaku)")
status68=$(systemctl status xray             | grep -i "active (mlaku)")
status69=$(systemctl status xray             | grep -i "active (mlaku)")
status70=$(systemctl status xray             | grep -i "active (mlaku)")
status67=$(systemctl status xray             | grep -i "active (mlaku)")
status67=$(systemctl status xray             | grep -i "active (mlaku)")
status57=$(systemctl status xray             | grep -i "active (mlaku)")
status67=$(systemctl status xray             | grep -i "active (mlaku)")
